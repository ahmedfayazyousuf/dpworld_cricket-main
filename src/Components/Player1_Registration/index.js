...
const Player1Registration = () =>{
    ...
    async function postData() {
        const url = 'https://talli.app/api/kiosk/log_interaction';
        const data = {
            access_token: 'c221593d7d91818bf92dab26685332c1c03aa4d01b374153e11c5e59946f8d943d7dcaa4bf058aef92df234f2374fffc6c9332f5af29ec5725eb9faae0a3de4bCfATlanIRtvCQJSQtWBgcREVJapnTmhFm47EDyl2USYUKFASaCx7spuuhZvg9soX',
            interaction_id: 'form_submission',
            timestamp:firebase.firestore.FieldValue.serverTimestamp()

          };
      
     // Send a POST request to your local server
fetch('https://cricketservertwo.vercel.app/api/kiosk/log_interaction', {
    method: 'POST',
    headers: {
    ...
    .then((data) => {
      // Handle the response from the proxy server or external API
      console.log(data);
    })
    .catch((error) => {
    ...
    return( 
        ...
        <div style={{display: 'flex', flexDirection: 'column', width: '70%', gap:'5px', alignItems: 'center', justifyContent:'center'}}>
            ...
            <div style={{width:"103%", display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
